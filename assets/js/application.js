...
(function($) {
  ...
  $(function() {
    ...
    $("select[id='info']").selectpicker({style: 'btn-default'});
    $("select[id='kategori_id']").selectpicker({style: 'btn-default'});
    $("select[id='ana_faaliyet_alani']").selectpicker({style: 'btn-default'});
